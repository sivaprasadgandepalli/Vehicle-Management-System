                ...
                <form action='/action_page.php' className='bg-default p-4'>
                    <div class="form-group ">
                       <div className='row'>
                        ...
                        <input type='text' className='form-control'required placeholder='ENTER YOUR NAME'></input>
                        </div>
                        </div>
                    </div>
                    <br/>
                    <div class="form-group ">
                       <div className='row'>
                        ...
                        <div className='col-md-9'>
                        <input type='email' className='form-control'required placeholder='ENTER YOUR MAIL'></input>
                        </div>
                        </div>
                    </div>
                    <br/>
                    <div class="form-group ">
                       <div className='row'>
                        ...
                        <div className='col-md-9'>
                        <input type='number' className='form-control' required placeholder='ENTER MOBILE NUMBER'></input>
                        </div>
                        </div>
                    </div>
                    <br/>
                    <div class="form-group ">
                       <div className='row'>
                        ...
                        <div className='col-md-9'>
                        <input type='text' className='form-control' placeholder='REASON FOR CONTACT'></input>
                        </div>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="col-md-4">
					    <input type="reset" className="form-control " name="" value="RESET ALL DATA"></input></div>
                    <div class="col-md-4">
					    <input type="submit" className="form-control btn btn-success" name="" value="Send" onClick={handleShow}></input>
                    </div>
