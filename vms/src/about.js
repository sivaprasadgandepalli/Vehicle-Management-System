            ...
            <p id='abouthead'>ABOUT</p>
                <div className='col-md-6' >
                    <div className='card' id='content'>
                        <h4>What is VMS?</h4>
                        <p id='first'>
                            Vehicle Management Systems (VMS) have become
                            increasingly important over time in space missions, due
                            both to the demands for increased flexibility and capability
                            of these missions, and the supply of increasingly capable
                            computing systems to provide this improved functionality.
                            VMSs include the management of uncertainties in vehicle
                            state, which is the vehicle portion of System Health
                            Management (SHM). 
                        </p>
                        <p style={{display:show}}>SHM and
                                SOM functions can be allocated to humans or machines,
                                whether on the ground or on-board. To the extent these are
                                allocated to the vehicle’s machines (as opposed to crew),
                                these are part of the Vehicle Management System. </p>
                        <button className='btn btn-danger' onClick={State}>{bval}</button>
                    </div>
                </div>
            ...
            <div className='row'>
                ...
                <div className='col-md-3' id='features'>
                    ...
                    <h4>1.Driving behaviour analysis</h4>
                        <p>The best fleet management systems will have a feature to monitor
                ...
                <div className='col-md-3' id='features'>
                    ...
                    <h4>2.Route monitoring</h4>
                        <p>This feature will help you to monitor the execution of routes 
                            and anticipate future events, supporting your fleet management 
                ...
                <div className='col-md-3' id='features'>
                    ...
                    <h4>3.Gps Tracking system</h4>
                        <p>The GPS tracking device is essential on a GPS vehicle tracking
                             and fleet management system. Once the technician installs these 
                ...
                <div className='col-md-3' id='features'>
                    ...
                    <h4>4.Fuel Management</h4>
                        <p>This helps you and your team to identify cases of leaks or theft quickly.
                            You can set alarms to warn you and the driver immediately, whenever draining takes 
                            place and get a permanent measurement of the fuel level in tanks.
                            Average fuel consumption is also calculated, per vehicle and time period.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className='row' id='profiles'>
                ...
                <div className='col-md-3'>
                    <div className='card'>
                        ...
                        <div className='img2'><img src={Timg}/></div>
                ...
                <div className='col-md-3'>
                    <div className='card'>
                        <div className='img1'><img src={img}/></div>
                        <div className='img2'><img src={img3}/></div>
                        <div className='content'>
                            <h5>Naresh M</h5>
                            <figcaption>Full stack developer</figcaption>
                        </div>
